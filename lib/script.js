(function() {
  var BabaScript, Client, EventEmitter, LindaSocketIOClient, SocketIOClient, UserAttribute, Util, async, http, mm, moment, request, sys, _,
        ...
        return request.get("" + host + ":" + port + "/api/group/" + this.id + "/member").end((function(_this) {
          return function(err, res) {
            ...
            if ((res != null ? res.statusCode : void 0) === 200) {
              ...
              request.get("" + host + ":" + port + "/api/users").send({
                names: names
                ...
                if ((res != null ? res.statusCode : void 0) === 200) {
                  ...
                  for (_l = 0, _len3 = _ref5.length; _l < _len3; _l++) {
                    ...
                    _results.push(_this.membersData.push(userAttribute));
                  }
                  return _results;
                }
              });
