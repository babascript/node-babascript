(function() {
  var BabaScript, EventEmitter, LindaSocketIOClient, ManagerClient, SocketIOClient, async, http, mm, moment, request, sys, _,
  ...
  module.exports = BabaScript = (function(_super) {
    ...
    BabaScript.prototype.api = 'http://linda.babascript.org';
    ...
    function BabaScript(id, options) {
      ...
      socket = SocketIOClient.connect(options.linda || this.api);
      if (this.linda == null) {
    ...
    BabaScript.prototype.connect = function() {
      return request.get("" + this.api + "/api/imbaba/" + this.id).end((function(_this) {
        return function(err, res) {
          var member, members, _i, _len;
          if (res.statusCode === 202) {
            members = res.body;
            _this.workers = [];
            for (_i = 0, _len = members.length; _i < _len; _i++) {
              member = members[_i];
              _this.workers.push(new BabaScript(member));
            }
          }
          _this.next();
    ...
    BabaScript.prototype.wait = function() {
      console.log(this);
