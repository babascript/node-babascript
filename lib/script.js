(function() {
  ...
  module.exports = BabaScript = (function(_super) {
    ...
    function BabaScript(id, options) {
      ...
      return mm.call(this, this, (function(_this) {
    ...
    BabaScript.prototype.connect = function() {
      var host, port, user, _i, _len, _ref, _ref1, _ref2;
      _ref = this.linda.io.socket.options, host = _ref.host, port = _ref.port;
      if (((_ref1 = this.options) != null ? _ref1.users : void 0) != null) {
        this.workers = [];
        _ref2 = this.options.users;
        ...
        return request.get("" + host + ":" + port + "/api/group/" + this.id + "/member").end((function(_this) {
          return function(err, res) {
            var member, members, _j, _k, _len1, _len2, _ref3;
            if ((res != null ? res.statusCode : void 0) === 200) {
              ...
              if (_.isArray(members)) {
                for (_k = 0, _len2 = members.length; _k < _len2; _k++) {
                  ...
                  _this.workers.push(new BabaScript(member.username));
                }
              } else {
                _this.workres.push(members);
              }
            }
    ...
    BabaScript.prototype.waitReturn = function(cid, callback) {
      return this.sts.take({
        ...
        return function(err, tuple) {
          ...
          _this.sts.take(t, function() {
            return console.log('eval take?');
          });
          return _this.sts.take(tt, function() {
            return console.log('broadcast take?');
          });
        };
      })(this));
    };
    ...
    BabaScript.prototype.createWorker = function(id) {
      return _.find(this.workers, function(w) {
        return w.id() === id;
      });
    };
