(function() {
  ...
  module.exports = BabaScript = (function(_super) {
    ...
    BabaScript.prototype.connect = function() {
      ...
      if (((_ref1 = this.options) != null ? _ref1.manager : void 0) == null) {
        ...
        for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
          ...
          this.workers.push(new BabaScript(u.username, _options || {}));
        }
        return setImmediate((function(_this) {
          return function() {
            _this.next();
        ...
        return request.get("" + host + ":" + port + "/api/group/" + this.id + "/member").end((function(_this) {
          return function(err, res) {
            var member, members, users, _j, _k, _l, _len1, _len2, _len3, _ref4;
            if ((res != null ? res.statusCode : void 0) === 200) {
              ...
              for (_k = 0, _len2 = members.length; _k < _len2; _k++) {
                ...
                _this.workers.push(new BabaScript(member.username, _options || {}));
              }
            } else {
              ...
              for (_l = 0, _len3 = users.length; _l < _len3; _l++) {
                ...
                _this.workers.push(new BabaScript(u, _options || {}));
              }
            }
      ...
      return this.sts.take({
        ...
        return function(err, tuple) {
          ...
          result = {
            ...
            worker: _this.getWorker(tuple.data.worker)
          };
    ...
    BabaScript.prototype.getWorker = function(id) {
      var w;
      w = _.find(this.workers, function(w) {
        return w.id() === id;
      });
      if (w == null) {
        ...
        w = new BabaScript(id, this.options || {});
        this.workers.push(w);
      }
      return w;
    };
