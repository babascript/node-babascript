(function() {
  var Client, EventEmitter, Linda, LindaBase, LindaClient, LindaSocketIOClient, Manager, Parse, Script, SocketIOClient, TupleSpace, VirtualClient, async, mm, moment, sync, sys, _,
