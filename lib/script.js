(function() {
  var BabaScript, BabaScriptBase, EventEmitter, LindaAdapter, Promise, mm,
  ...
  BabaScript = (function(_super) {
    ...
    BabaScript.prototype.__exec = function(task) {
      var name, plugin, taskid, tuple, _ref, _ref1;
    ...
    BabaScript.prototype.createTuple = function(task) {
      var key, tuple, value, _ref, _ref1;
      tuple = {
        baba: 'script',
        name: this.id,
        type: 'eval',
        key: task.key,
        cid: task.cid,
        format: ((_ref = task.options) != null ? _ref.format : void 0) || this.defaultFormat,
        at: Date.now(),
        options: {}
      };
      ...
      for (key in _ref1) {
        ...
        if (key === 'broadcast') {
          ...
          setTimeout((function(_this) {
            return function() {
              return _this.cancel(task.cid, 'timeout');
            };
          })(this), value);
        } else {
