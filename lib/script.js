(function() {
  ...
  BabaScriptBase = (function(_super) {
    ...
    function BabaScriptBase(id, options) {
      ...
      this.getMembers = __bind(this.getMembers, this);
    ...
    BabaScriptBase.prototype.humanExec = function(key, args) {
      var callback, cancelid, cid, h, i, module, name, ts, tuple, _i, _ref, _ref1;
        ...
        async.parallel(h, (function(_this) {
          return function(err, results) {
            ...
            return setImmediate(function() {
              var module, name, _base, _ref2;
              if (Object.keys(_this.modules).length > 0) {
                _ref2 = _this.modules;
                for (name in _ref2) {
                  module = _ref2[name];
                  if (module.body.receive != null) {
                    if (typeof (_base = module.body).receive === "function") {
                      _base.receive(results);
                    }
                  }
                }
              }
    ...
    BabaScriptBase.prototype.createTupleWithOption = function(key, cid, option) {
      ...
      for (k in option) {
        ...
        switch (k) {
          case "broadcast":
            if (v === 'all') {
              tuple.count = this.getMembers.length - 1;
            } else {
              tuple.count = v - 1;
            }
    ...
    BabaScriptBase.prototype.getMembers = function() {
      var names, ts, _i, _len, _ref;
      names = [];
      _ref = this.sts;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ts = _ref[_i];
