(function() {
  var BBObject, Crypto, DeviceModel, Group, GroupModel, Linda, LindaSocketIO, LocalStrategy, Manager, TupleSpace, User, UserModel, express, mongoose, passport, _,
  ...
  Manager = (function() {
    ...
    Manager.prototype.login = function(attrs, callback) {
    ...
    Manager.prototype.User = {
      ...
      _read: function(req, res) {
        return Manager.getUser(req.params.name, function(err, user) {
